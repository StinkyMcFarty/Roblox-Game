...
require(script.Parent:WaitForChild("Brightness"))
require(script.Parent:WaitForChild("MapLife"))
...
require(script.Parent:WaitForChild("RulesScreen"))
require(script.Parent:WaitForChild("SuitBeacon"))
