...
Skins.List = {
	Logan = {
		...
		Face = { Eyes = "plain" }, -- built face: brows, snarl, mutton chops
	...
	Comic = {
		...
		Face = { Eyes = "mask", MaskJaw = true, Hair = rgb(18, 16, 16) },
	...
	WeaponX = {
		...
		Face = { Eyes = "none", Hair = rgb(34, 26, 21) },
