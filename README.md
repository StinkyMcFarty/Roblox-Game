...
### Recent rules
- **Pounce** only works while Wolverine is running on all fours (hold C / Ctrl). It's a dive that rises about 7 studs, just under the 12.4-stud Hangar entrance, and covers the same ~72 studs as the old high leap. If it catches nobody, it ends in a landing crouch the moment he touches down (`Config.Abilities.Pounce.Height` / `AirTime`).
